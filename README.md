...
Can Echo Mirror prove one thing that helps a user within 14 days?
...
- DB URL comes from `DATABASE_URL`, otherwise SQLite uses `SQLITE_PATH` (default `echomirror.db`).
